defines = {
	...
	diplomacy = {
		...
		MAX_INFLUENCE = 100,
		WARSUBSIDIES_PERCENT = 0.3, -- How many percent of imports you are going to pay each day(mil. constructions and mil. maintenance)
	...
	pops = {
		...
		MIL_ON_REB_MOVE = 8,
		POPULATION_SUPPRESSION_FACTOR = 0.0, -- controls base pop size for factor of suppression/radicalness cost. zero  disables the feature and just uses radicalness
	...
	ai = {
		...
		EDUCATOR_WEIGHT = 25.0, -- ai weight for new clergy
